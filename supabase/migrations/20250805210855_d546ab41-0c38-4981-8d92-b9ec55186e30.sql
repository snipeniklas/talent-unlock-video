-- Stelle die ursprüngliche Trigger-Funktion wieder her
DROP TRIGGER IF EXISTS trigger_notify_admins_new_support_message ON public.support_messages;

-- Erstelle den ursprünglichen Trigger wieder, aber mit verbessertem Error Handling
