-- Korrigiere die Trigger-Funktion - das Problem ist, dass wir versuchen auf eine "status" Spalte zuzugreifen die nicht existiert
...
BEGIN
    ...
    BEGIN
        -- Get ticket information (benutze nur existierende Spalten)
        SELECT 
            title, 
            category, 
            priority, 
