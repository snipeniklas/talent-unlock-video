-- Update the trigger function to set next_send_date when adding contacts to campaigns
...
AS $function$
BEGIN
  -- Add the new contact to all active/draft campaigns that use this list
