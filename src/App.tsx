...
import CrmContactListDetail from "./pages/admin/CrmContactListDetail";
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/admin" element={
            ...
            <Route path="crm/contact-lists/:id" element={<CrmContactListDetail />} />
            <Route path="crm/tasks" element={<CrmTasks />} />
            <Route path="crm/tasks/new" element={<CrmTaskForm />} />
            <Route path="crm/tasks/:id" element={<CrmTaskDetail />} />
            <Route path="crm/tasks/:id/edit" element={<CrmTaskForm />} />
