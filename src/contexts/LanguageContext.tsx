...
const translations = {
  de: {
    ...
    // HomePage - Services (restored original German content)
    'services.backoffice.title': 'Remote Backoffice',
    'services.backoffice.description': 'Unterstützung bei administrativen Aufgaben durch qualifizierte Remote-Mitarbeiter',
    'services.backoffice.features.organization': 'Organisation & Planung',
    'services.backoffice.features.accounting': 'Buchhaltung & Finanzen',
    'services.backoffice.features.support': 'Kundensupport',
    'services.it.title': 'IT Development',
    'services.it.description': 'Talentierte Entwickler für moderne Software-Lösungen',
    'services.it.features.fullstack': 'Frontend & Backend',
    'services.it.features.devops': 'DevOps & Infrastructure',
    'services.it.features.mobile': 'Mobile Development',
    'services.aiml.title': 'AI & ML',
    'services.aiml.description': 'Experten für Künstliche Intelligenz und Machine Learning',
    'services.aiml.features.ml': 'Machine Learning Modelle',
    'services.aiml.features.datascience': 'Data Science & Analytics',
    'services.aiml.features.strategy': 'AI-Strategieberatung',
    'services.cta.button': 'Kostenlos anfragen',
    
    // HomePage - Stats (restored original German content)
    'stats.title': 'Vertrauen Sie auf bewährte Expertise',
    'stats.subtitle': 'Zahlen, die für sich sprechen',
    'stats.award': '🏆 Ausgezeichnet als "Top Remote Talent Partner 2023"',
    'stats.awardDescription': 'Über 150 Unternehmen nutzen bereits unsere innovativen RaaS-Lösungen. Von der Startup-Phase bis zur Skalierung - wir begleiten Sie.',
    'stats.specialists': 'Qualifizierte Fachkräfte',
    'stats.placements': 'Erfolgreiche Vermittlungen',
    'stats.satisfaction': 'Kundenzufriedenheit',
    'stats.time': 'Wochen bis zur Besetzung',
    'stats.cta.title': 'Starten Sie in nur 3 Minuten',
    'stats.cta.description': 'Erzählen Sie uns von Ihrem Bedarf und erhalten Sie binnen 24h passende Kandidatenvorschläge. Völlig kostenfrei.',
    ...
    // Testimonials (restored original German content)
    'testimonials.niklas.text': 'Hej Talent hat uns geholfen, unsere Entwicklerressourcen zu erweitern, ohne die Qualität zu beeinträchtigen. Der Auswahlprozess war transparent und die Kandidaten haben unsere Erwartungen übertroffen.',
    'testimonials.niklas.name': 'Niklas Braun',
    'testimonials.niklas.company': 'TechStart GmbH',
    'testimonials.marc.text': 'Die AI/ML Fachkräfte von Hej Talent haben unser Projekt in die richtige Richtung gelenkt. Ihr tiefes Verständnis für moderne KI-Technologien war beeindruckend.',
    'testimonials.marc.name': 'Marc Weber',
    ...
    // FloatingAppDemo translations
    'demo.dashboard.title': 'RaaS Dashboard',
    'demo.dashboard.status': 'Live',
    'demo.dashboard.activeProjects': 'Aktive Projekte',
    'demo.dashboard.successRate': 'Erfolgsrate',
    'demo.dashboard.remoteDevelopers': 'Remote-Entwickler',
    'demo.dashboard.backofficeStaff': 'Backoffice-Kräfte',
    'demo.dashboard.active': 'aktiv',
    'demo.search.title': 'Neue RaaS Anfrage',
    'demo.search.subtitle': 'Python Entwickler gesucht',
    'demo.search.responseIn24h': 'Antwort in 24h erwartet',
    'demo.search.candidatesFound': 'Kandidaten gefunden',
    'demo.search.viewDetails': 'Details ansehen',
    'demo.resources.title': 'Ressourcen Pool',
    'demo.resources.subtitle': 'Verfügbare Experten',
    'demo.resources.aimlExperts': 'AI/ML Experten',
    'demo.resources.fullstackDev': 'Fullstack Dev',
    'demo.resources.backoffice': 'Backoffice',
    'demo.performance.title': 'Performance',
    'demo.performance.thisMonth': 'diesen Monat',
    'demo.performance.successfulMatches': 'Erfolgreiche Matches',
    'demo.performance.avgPlacementTime': 'Ø Besetzungszeit',
    'demo.performance.weeks': 'Wochen',
    'demo.performance.customerSatisfaction': 'Kundenzufriedenheit',
    'demo.notification.title': 'Match gefunden!',
    'demo.notification.description': 'Perfekter Python-Entwickler für Ihr KI-Projekt verfügbar. 5⭐ Bewertung, sofort startbereit.',
    'demo.notification.viewProfile': 'Profil ansehen',
    'demo.notification.later': 'Später',
    'demo.cta.button': 'RaaS Anfrage starten',

    // InteractiveAppScreen translations
    'interactive.dashboard.title': 'Dashboard',
    'interactive.dashboard.subtitle': 'Übersicht Ihrer RaaS-Aktivitäten',
    'interactive.dashboard.requestResource': 'Ressource anfragen',
    'interactive.dashboard.activeProjects': 'Aktive Projekte',
    'interactive.dashboard.assignedResources': 'Zugeteilte Ressourcen',
    'interactive.dashboard.completedProjects': 'Abgeschlossene Projekte',
    'interactive.dashboard.waitingResources': 'Wartende Ressourcen',
    'interactive.dashboard.recentActivities': 'Aktuelle Aktivitäten',
    'interactive.dashboard.activity1': 'Neue Ressource für AI-Entwickler Projekt zugewiesen',
    'interactive.dashboard.activity2': 'Ressourcenanfrage \'Data Science Spezialist\' aktualisiert',
    'interactive.dashboard.activity3': 'Projekt \'Buchhaltungs-Ressource\' erfolgreich abgeschlossen',
    'interactive.dashboard.timeAgo2h': 'vor 2h',
    'interactive.dashboard.timeAgo4h': 'vor 4h',
    'interactive.dashboard.timeAgo1d': 'vor 1d',
    'interactive.searchRequests.title': 'Suchaufträge',
    'interactive.searchRequests.createNew': 'Neuen Auftrag erstellen',
    'interactive.searchRequests.all': 'Alle',
    'interactive.searchRequests.active': 'Aktiv',
    'interactive.searchRequests.completed': 'Abgeschlossen',
    'interactive.searchRequests.resources': 'Ressourcen',
    'interactive.resources.title': 'Verfügbare Ressourcen',
    'interactive.resources.viewAll': 'Alle anzeigen',
    'interactive.resources.availableImmediately': 'Sofort verfügbar',
    'interactive.resources.availableIn2Weeks': 'In 2 Wochen',
    'interactive.resources.availableIn1Month': 'In 1 Monat',
    'interactive.admin.title': 'Admin Dashboard',
    'interactive.admin.badge': 'Hej Talent Admin',
    'interactive.admin.registeredCompanies': 'Registrierte Unternehmen',
    'interactive.admin.availableResources': 'Verfügbare Ressourcen',
    'interactive.admin.management': 'Verwaltung',
    'interactive.admin.userManagement': 'Benutzerverwaltung',
    'interactive.admin.companyManagement': 'Unternehmen verwalten',
    'interactive.admin.resourceAllocation': 'Ressourcen zuweisen',
    'interactive.admin.analytics': 'Analytics & Reports',

    // Mock data translations
    'mock.searchRequest1.title': 'Remote AI Entwickler (Python)',
    'mock.searchRequest1.company': 'TechCorp GmbH',
    'mock.searchRequest1.created': 'vor 2 Tagen',
    'mock.searchRequest2.title': 'Buchhaltungs-Ressource Teilzeit',
    'mock.searchRequest2.company': 'StartupTech',
    'mock.searchRequest2.created': 'vor 1 Woche',
    'mock.searchRequest3.title': 'Data Science Spezialist',
    'mock.searchRequest3.company': 'DataCorp',
    'mock.searchRequest3.created': 'vor 2 Wochen',
    'mock.resource1.name': 'Max Mustermann',
    'mock.resource1.position': 'Senior AI Engineer',
    'mock.resource1.location': 'Berlin',
    'mock.resource2.name': 'Sarah Schmidt',
    'mock.resource2.position': 'Buchhaltungsexpertin',
    'mock.resource2.location': 'Hamburg',
    'mock.resource3.name': 'Dr. Anna Weber',
    'mock.resource3.position': 'Data Scientist',
    'mock.resource3.location': 'München'
  },
  en: {
    // Navigation
    ...
    'demo.dashboard.title': 'RaaS Dashboard',
    'demo.dashboard.status': 'Live',
    'demo.dashboard.activeProjects': 'Active Projects',
    'demo.dashboard.successRate': 'Success Rate',
    'demo.dashboard.remoteDevelopers': 'Remote Developers',
    'demo.dashboard.backofficeStaff': 'Backoffice Staff',
    'demo.dashboard.active': 'active',
    'demo.search.title': 'New RaaS Request',
    'demo.search.subtitle': 'Python Developer Needed',
    'demo.search.responseIn24h': 'Response in 24h expected',
    'demo.search.candidatesFound': 'Candidates found',
    'demo.search.viewDetails': 'View Details',
    'demo.resources.title': 'Resource Pool',
    'demo.resources.subtitle': 'Available Experts',
    'demo.resources.aimlExperts': 'AI/ML Experts',
    'demo.resources.fullstackDev': 'Fullstack Dev',
    'demo.resources.backoffice': 'Backoffice',
    'demo.performance.title': 'Performance',
    'demo.performance.thisMonth': 'this month',
    'demo.performance.successfulMatches': 'Successful Matches',
    'demo.performance.avgPlacementTime': 'Avg Placement Time',
    'demo.performance.weeks': 'weeks',
    'demo.performance.customerSatisfaction': 'Customer Satisfaction',
    'demo.notification.title': 'Match found!',
    'demo.notification.description': 'Perfect Python developer for your AI project available. 5⭐ rating, ready to start immediately.',
    'demo.notification.viewProfile': 'View Profile',
    'demo.notification.later': 'Later',
    'demo.cta.button': 'Start RaaS Request',
    'interactive.dashboard.title': 'Dashboard',
    'interactive.dashboard.subtitle': 'Overview of your RaaS activities',
    'interactive.dashboard.requestResource': 'Request Resource',
    'interactive.dashboard.activeProjects': 'Active Projects',
    'interactive.dashboard.assignedResources': 'Assigned Resources',
    'interactive.dashboard.completedProjects': 'Completed Projects',
    'interactive.dashboard.waitingResources': 'Waiting Resources',
    'interactive.dashboard.recentActivities': 'Recent Activities',
    'interactive.dashboard.activity1': 'New resource assigned to AI developer project',
    'interactive.dashboard.activity2': 'Resource request \'Data Science Specialist\' updated',
    'interactive.dashboard.activity3': 'Project \'Accounting Resource\' successfully completed',
    'interactive.dashboard.timeAgo2h': '2h ago',
    'interactive.dashboard.timeAgo4h': '4h ago',
    'interactive.dashboard.timeAgo1d': '1d ago',
    'interactive.searchRequests.title': 'Search Requests',
    'interactive.searchRequests.createNew': 'Create New Request',
    'interactive.searchRequests.all': 'All',
    'interactive.searchRequests.active': 'Active',
    'interactive.searchRequests.completed': 'Completed',
    'interactive.searchRequests.resources': 'Resources',
    'interactive.resources.title': 'Available Resources',
    'interactive.resources.viewAll': 'View All',
    'interactive.resources.availableImmediately': 'Available immediately',
    'interactive.resources.availableIn2Weeks': 'Available in 2 weeks',
    'interactive.resources.availableIn1Month': 'Available in 1 month',
    'interactive.admin.title': 'Admin Dashboard',
    'interactive.admin.badge': 'Hej Talent Admin',
    'interactive.admin.registeredCompanies': 'Registered Companies',
    'interactive.admin.availableResources': 'Available Resources',
    'interactive.admin.management': 'Management',
    'interactive.admin.userManagement': 'User Management',
    'interactive.admin.companyManagement': 'Company Management',
    'interactive.admin.resourceAllocation': 'Resource Allocation',
    'interactive.admin.analytics': 'Analytics & Reports',
    'mock.searchRequest1.title': 'Remote AI Developer (Python)',
    'mock.searchRequest1.company': 'TechCorp GmbH',
    'mock.searchRequest1.created': '2 days ago',
    'mock.searchRequest2.title': 'Part-time Accounting Resource',
    'mock.searchRequest2.company': 'StartupTech',
    'mock.searchRequest2.created': '1 week ago',
    'mock.searchRequest3.title': 'Data Science Specialist',
    'mock.searchRequest3.company': 'DataCorp',
    'mock.searchRequest3.created': '2 weeks ago',
    'mock.resource1.name': 'Max Mustermann',
    'mock.resource1.position': 'Senior AI Engineer',
    'mock.resource1.location': 'Berlin',
    'mock.resource2.name': 'Sarah Schmidt',
    'mock.resource2.position': 'Accounting Expert',
    'mock.resource2.location': 'Hamburg',
    'mock.resource3.name': 'Dr. Anna Weber',
    'mock.resource3.position': 'Data Scientist',
    'mock.resource3.location': 'Munich'
  }
};
